        ...
        <div className="section-responsive relative z-10">
          ...
          >
            ...
            <h1 className="heading-premium text-5xl md:text-7xl font-bold mb-8 text-white leading-tight">
              About <span className="italic bg-luxury-gradient bg-clip-text text-transparent">XYZ Chambers</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6 text-gray-400 font-inter font-medium leading-relaxed text-base">
                <p>
                  Established in 1999, XYZ Chambers emerged with a clear vision: to redefine legal practice in Nigeria. What began as a boutique litigation firm has evolved into a full-service enterprise legal powerhouse, advising multi-national corporations, government entities, and private clients.
                </p>
                <p>
                  Our culture is rooted in the &quot;XYZ Philosophy&quot;&mdash;a belief that strength comes from meticulous preparation and justice is driven by relentless advocacy.
                </p>
              </div>
