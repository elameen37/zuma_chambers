                  ...
                  {isProfileDropdownOpen && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="absolute right-0 mt-3 w-60 z-50 glass-panel border border-white/10 rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-onyx/70 backdrop-blur-2xl"
                      >
